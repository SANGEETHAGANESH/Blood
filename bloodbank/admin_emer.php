    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown">Donor Request</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item text-dark" href="admin_donation_request.php">Regular Donor</a>
                            <a class="dropdown-item text-dark" href="admin_emer.php">Emergency Donor</a>
                        </div>
                    </li>  <li><a style="text-decoration:none;" href="admin_blood_request.php">Blood Request</a></li>
